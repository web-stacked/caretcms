...
| 2026-09-13 | Release preparation | Prepared the coordinated `0.4.0` package versions, changelog entry, and release notes | `npm run check`: 1,012 unit tests in 111 files; all four npm publish dry runs passed |
